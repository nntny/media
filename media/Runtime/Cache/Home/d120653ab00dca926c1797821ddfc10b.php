    ...
    <div class="fansnumber">
        ...
        <div class="container">
            ...
            <div class="content_number">
                <a href="javascript:;" id="singlecount">单篇统计</a>
                <a href="javascript:;" style="margin: 0 0 0 18%">整体统计</a>
                <span></span>
            </div>
            <!-- 粉丝属性部分 -->
            ...
            <div class="content_all">
                <p>
                    ...
                    <br>
                    <a href="javascript:;">日：&nbsp; <?php echo ($viewPercent); ?> 
                        <?php if(($viewPercent > 0) and ($viewPercent != 0)): ?><i class="iconfont icon-oranger">&#xe729;</i>
                        <?php elseif(($viewPercent < 0) and ($viewPercent != 0)): ?>
                            <i class="iconfont icon-blue">&#xe72a;</i><?php endif; ?>
                    </a>
                    <br>
                    <i class="number">阅读量</i>
                </p>
                <div></div>
                <p>
                    <span><?php echo ($com); ?></span>
                    <br>
                    <a href="javascript:;">日：&nbsp; <?php echo ($comPercent); ?> </a>
                        <?php if(($comPercent > 0) and ($comPercent != 0)): ?><i class="iconfont icon-oranger">&#xe729;</i>
                        <?php elseif(($comPercent < 0) and ($comPercent != 0)): ?>
                            <i class="iconfont icon-blue">&#xe72a;</i><?php endif; ?>
                    <br>
                    <i class="number">评论量</i>
                </p>
                <div></div>
                <p>
                    <span><?php echo ($share); ?></span>
                    <br>
                    <a href="javascript:;">日：&nbsp; <?php echo ($sharePercent); ?> 
                        <?php if(($sharePercent > 0) and ($sharePercent != 0)): ?><i class="iconfont icon-oranger">&#xe729;</i>
                        <?php elseif(($sharePercent < 0) and ($sharePercent != 0)): ?>
                            <i class="iconfont icon-blue">&#xe72a;</i><?php endif; ?>
                    </a>

                    <br>
                    <i class="number">分享量</i>
                </p>
                <div></div>
                <p>
                    <span><?php echo ($fav); ?></span>
                    <br>
                    <a href="javascript:;">日：&nbsp; <?php echo ($favPercent); ?> 
                        <?php if(($favPercent > 0) and ($favPercent != 0)): ?><i class="iconfont icon-oranger">&#xe729;</i>
                        <?php elseif(($favPercent < 0) and ($favPercent != 0)): ?>
                            <i class="iconfont icon-blue">&#xe72a;</i><?php endif; ?>
                    </a>
                    <br>
                    <i class="number">收藏量</i>
                </p>
            </div>
            <!-- 数据概述部分 -->
            <div class="allinformation">
 ...
 -->
    ...
    <script type="text/javascript">
        ...
        function totalData(day){
            var html = '';
            $.ajax({
                url: '<?php echo U("Home/Count/totalData");?>',
                type: 'POST',
                data: {'day': day},
                success:function(data){
                    html += '<tr class="time">';
                        ...
                        html += '<th>收藏量</th>';
                    html += '</tr>';
                    for(var i=0;i<data.detailRes.length;i++){
                        html += '<tr>';
                            html += '<td>'+data.detailRes[i]['day']+'</td>';
                            html += '<td>'+data.detailRes[i]['view']+'</td>';
                            html += '<td>'+data.detailRes[i]['comment']+'</td>';
                            html += '<td>'+data.detailRes[i]['share']+'</td>';
                            html += '<td>'+data.detailRes[i]['fav']+'</td>';
                        html += '</tr>';                        
                    }
                    ...
                    for(var i = 0; i < data.viewData.length ; i++){
                        viewData[i] = data.viewData[i];
                    }
                    for(var i = 0; i < data.comData.length ; i++){
                        comData[i] = data.comData[i];
                    }
                    for(var i = 0; i < data.shareData.length ; i++){
                        shareData[i] = data.shareData[i];
                    }
                    for(var i = 0; i < data.favData.length ; i++){
                        favData[i] = data.favData[i];
                    }
        ...
        $('#singlecount').click(function(event) {
